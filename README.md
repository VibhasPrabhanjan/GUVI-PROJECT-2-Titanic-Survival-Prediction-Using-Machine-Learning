...
With my chosen model in place, I apply it to predict survival on the test dataset. I then create a **Gen_submission final output file**, a critical step for evaluation purposes, allowing me to see how well my model generalizes to new and unseen data.
